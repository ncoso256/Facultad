...
public class Producto {
    ...
    */
    ...
    public String toString() { // armado por insert code tiene que ser si o si toString el nombre porque si no es no puedo hacer
        ...
        return "Producto{" + "precio=" + precio + ", nombre=" + nombre + ", descripcion=" + descripcion + ", nombre1=" + nombre1 + ", precio1=" + precio1 + ", nombre2=" + nombre2 + ", descripcion1=" + descripcion1 + ", precio2=" + precio2 + '}';
    }
