/*
2- Queremos un sistema para gestionar estacionamientos. 
Un estacionamiento conoce su nombre, dirección, hora de apertura, hora de cierre, 
y almacena para cada número de piso (1..N) y número de plaza (1..M), el auto que ocupa dicho lugar.
...
- Un constructor debe recibir nombre y dirección,
e iniciar el estacionamiento con hora de apertura “8:00”
, hora de cierre “21:00”, y para 5 pisos y 10 plazas por piso. 
El estacionamiento inicialmente no tiene autos.

- Otro constructor debe recibir nombre,
dirección, hora de apertura, hora de cierre,
el número de pisos (N) y el número de plazas por piso (M) 
e iniciar el estacionamiento con los datos recibidos y sin autos.
...
Suponga que X, Y son válidos (es decir, están en rango 1..N y 1..M respectivamente) y que el lugar está desocupado.

- Dada una patente,obtener un String que contenga el número de piso y plaza donde está dicho auto en el estacionamiento.
...
public class Ejercicio2 {
    ...
    public static void main(String[] args) {
        Estacionamiento e = new Estacionamiento("Alto Palermo", "Buenos Aires", "10:30", "22:00", 3, 3);
        
        Auto a1 = new Auto("Carlos", "AX209");
        e.registrarAuto(a1, 0, 1);
       
        Auto a2 = new Auto("Roberto", "AX209");
        e.registrarAuto(a2, 1, 1);
       
        Auto a3 = new Auto("Juan", "AX207");
        e.registrarAuto(a3, 1, 2);
        
        Auto a4 = new Auto("Tomas", "AX209");
        e.registrarAuto(a4, 2, 2);
        
        Auto a5 = new Auto("Martin", "AX209");
        e.registrarAuto(a5, 0, 0);
        
        Auto a6 = new Auto("Julian", "AX205");
        e.registrarAuto(a6, 1, 0);
        
        System.out.println(e.toString());
        
        
        
        System.out.println(e.cantAutosPlaza(0));
        
        String patenteabuscar = Lector.leerString();
        System.out.println(e.buscarAuto(patenteabuscar));
    }
