...
Implemente métodos getters/setters adecuados.
...
d) Realice un programa que instancie un evento ocasional y una gira, cargando la información necesaria.
Luego, para ambos, imprima el costo e invoque al mensaje actuar.
...
public class JavaApplication4 {
    ...
    public static void main(String[] args) {
        ...
        eventoOcasional eo = new eventoOcasional("lolla", 4, "Beneficio", "Santaolalla", GeneradorAleatorio.generarInt(32)+1);
        
        Gira g = new Gira("Sting", 8, "In the city", 4);
        
        eo.agregarTema("TNT");
        
        Fecha f = new Fecha("La Plata", 2);
        g.agregarFecha(f);
